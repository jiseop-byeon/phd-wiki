...
### 2026-09-09 ME384R 햅틱·원격조작 전문 트랙 완성

비공개 과목 자료 51개 파일(강의·과제·Hapkit CAD/조립 자료·프로젝트/인간 대상 연구 문서·
읽기 자료)을 전수 검토하고, 원본을 재배포하지 않는 독립 학습 트랙으로 재구성했다.
...
### 2026-08-31 (1) ME384R 벤치마크 실행 — 심리물리 페이지 신설 + 12번 §4.5

ME384R(UT 햅틱·원격조작, Majewicz Fey) 실제 강의자료 2강 분량으로 벤치마크를 재측정하고,
