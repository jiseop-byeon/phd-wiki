...
- **VLA action spaces**: [[01-canonical-papers/notes/rt-1|RT-1]]'s 7-DoF action = end-effector
  position (3) + rotation (3) + gripper (1); [[01-canonical-papers/notes/pi0|π0]] outputs
  joint-space chunks — reading these requires exactly this page.
- **3D vision**: camera pose in [[01-canonical-papers/notes/nerf|NeRF]]/[[01-canonical-papers/notes/vggt|VGGT]]
...
- **VLA 행동 공간**: [[01-canonical-papers/notes/rt-1|RT-1]]의 7자유도 행동 = 말단 위치(3) +
  회전(3) + 그리퍼(1); [[01-canonical-papers/notes/pi0|π0]]는 관절 공간 청크를 출력 —
  이들을 읽는 데 정확히 이 페이지가 필요하다.
- **3D 비전**: [[01-canonical-papers/notes/nerf|NeRF]]/[[01-canonical-papers/notes/vggt|VGGT]]의
