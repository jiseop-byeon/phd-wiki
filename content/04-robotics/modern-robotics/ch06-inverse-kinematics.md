...
- Unlike FK, IK has **zero, one, several, or infinitely many** solutions (elbow-up vs
  ...
  [[01-canonical-papers/notes/diffusion-policy|generative policies]] beat regression on
...
**Wiki connections**: every teleop stack ([[01-canonical-papers/notes/act|ALOHA]]) and
...
- FK와 달리 IK의 해는 **0개, 1개, 여러 개, 무한히 많을 수** 있다(팔꿈치 위/아래; 7자유도
  팔은 연속체). 이 다봉성이 정확히 [[01-canonical-papers/notes/diffusion-policy|생성형
...
**위키 연결**: 모든 원격조작 스택([[01-canonical-papers/notes/act|ALOHA]])과 말단 공간 VLA가
