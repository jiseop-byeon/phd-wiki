...
**Evidence (with numbers)**: with the human-aware planner, tasks completed **5.57% faster**, concurrent human-robot motion rose **19.9%**, human idle time fell **2.96%**, robot idle time fell **17.3%**, and human-robot separation distance grew **15.1%**. Subjectively, participants agreed significantly more strongly that the robot stayed out of their way, that they felt safer and more comfortable, and that they trusted it as a teammate. The 2018 RA-L companion (Unhelkar, Lasota, ..., Shah — the first two contributed equally — "Human-Aware Robotic Assistant for Collaborative Assembly," RA-L 3(3)) carried the idea toward practice: a human-aware robotic assistant **fielded in a BMW test environment replicating final-assembly work** — the authors themselves note the demonstration is *not* representative of a real factory deployment.
