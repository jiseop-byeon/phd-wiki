...
- Power laws describe pretraining loss, not downstream abilities; emergent capabilities ([[01-canonical-papers/notes/gpt-3|GPT-3]]) are not directly predicted.
...
- Motivated: [[01-canonical-papers/notes/gpt-3|GPT-3]] · Applied everywhere from LLMs to VLAs
...
- 거듭제곱 법칙은 사전학습 손실을 기술할 뿐, 다운스트림 능력은 아니다; [[01-canonical-papers/notes/gpt-3|GPT-3]]의 창발적 능력은 직접 예측되지 않는다.
...
- 동기가 된 것: [[01-canonical-papers/notes/gpt-3|GPT-3]] · LLM부터 VLA까지 어디에나 적용
