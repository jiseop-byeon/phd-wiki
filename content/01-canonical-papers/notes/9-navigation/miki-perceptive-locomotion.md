...
> The Alpine hike is a *time-budget* result, not a success rate: the controller finished within a published human recommendation. That is a genuinely good metric — it is externally defined and not chosen by the authors — but it is a single route, and it is not a distribution over routes. As with [[01-canonical-papers/notes/9-navigation/lee-quadruped-terrain|Lee et al. 2020]], **the abstract contains no success rates and no comparison numbers.**
> 알프스 등반은 성공률이 아니라 *시간 예산* 결과다: 제어기가 공표된 사람 권장 시간 안에 완주했다. 외부에서 정의되었고 저자가 고르지 않았다는 점에서 정말 좋은 지표지만, 경로 하나이지 경로의 분포가 아니다. [[01-canonical-papers/notes/9-navigation/lee-quadruped-terrain|Lee 등 2020]]과 마찬가지로 **초록에 성공률도 비교 수치도 없다.**
...
> 알프스 산행은 성공률이 아니라 *시간 예산* 결과다: 제어기가 공표된 사람 권장 시간 안에 완주했다. 외부에서 정의되었고 저자가 고르지 않았다는 점에서 정말 좋은 지표지만, 경로 하나이지 경로의 분포가 아니다. [[01-canonical-papers/notes/9-navigation/lee-quadruped-terrain|Lee 등 2020]]과 마찬가지로 **초록에 성공률도 비교 수치도 없다.**
