...
**한 줄 요약**: RGB·힘/토크·고유수용감각을, 모달리티끼리 서로 만들어 주는 자기지도 목적함수로 하나의 압축된 잠재 표현에 융합하고, 원 입력이 아니라 그 잠재 공간에서 접촉이 많은 삽입을 학습한다.

### 배경

접촉이 많은 조작에는 비전(무엇이 어디 있는가)과 촉각(접촉에서 무슨 일이 일어나는가)이 둘 다
...
- **과제**: peg 삽입. 정본 접촉이 많은 문제이며, 삽입이 왜 어려운 경우인지는
...
> 견고하다"는 것이다. 정확한 표현에 유의하라 — 흔히 "다양한 기하"로 잘못 인용된다. 흔히
> 인용되는 삽입 성공률은 본문에만 있다. 인용하기 전에 본문에서 확인하라.
