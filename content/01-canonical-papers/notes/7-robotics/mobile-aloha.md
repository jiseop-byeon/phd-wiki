...
[[01-canonical-papers/notes/4-vla/act|ALOHA]]는 고정된 작업 영역에서의 양팔 시연 수집을 풀었다. 쓸모 있는 작업 대부분은 고정된 작업 공간에 있지 않다: 수납장 열기, 조리대 닦기, 방을 가로질러 무언가 옮기기 — 전부 베이스와 팔이 *함께* 움직여야 하고, 그것을 시연하려면 조작자가 둘을 동시에 몰 수 있는 인터페이스가 필요하다.
