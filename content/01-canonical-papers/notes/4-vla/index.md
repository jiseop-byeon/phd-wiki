...
| Skild Brain과 S1(Skild AI, 2025년 9월과 2026년 8월. 이 S1은 회사의 제품 이름으로, [[05-construction-robotics/site-engineering\|2.5]]가 정한 건설 트랙의 외장 패널 과제 S1과는 다르다) | 시뮬레이션에서 로봇 몸 $100{,}000$종으로 학습한 "옴니바디" 정책. S1은 문맥 속 비디오 하나로 새 과제를 익힌다 | 처음 보는 몸이나 망가진 몸에 몇 초 만에 적응. S1은 처음 보는 과제에서 VLA 기준선 $9\%$ 대비 $66\%$를 보고 | 회사 글([옴니바디](https://www.skild.ai/blogs/omni-bodied), [S1](https://skild.ai/blogs/s1)) |
