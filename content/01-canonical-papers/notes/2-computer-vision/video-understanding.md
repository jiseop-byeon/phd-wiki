...
- I3D: ~71–75% on Kinetics in the original paper (the ~80% figures are later longer-trained reproductions); transferred to then-SOTA 98.0%/80.9% on UCF-101/HMDB-51 —
...
- I3D: 원 논문 기준 Kinetics 약 71–75%(약 80%는 이후 더 길게 학습한 재현 수치); UCF-101/HMDB-51로 전이해 당시 SOTA 98.0%/80.9% — Kinetics
