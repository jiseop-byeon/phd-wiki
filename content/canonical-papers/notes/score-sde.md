...
- Next: DDIM, Flow Matching → π0 · Foundations: [[50-foundations/probability|probability]] (SDE ← random processes)
...
- 다음: DDIM, Flow Matching → π0 · 기초: [[50-foundations/probability|확률]] (SDE ← 랜덤 프로세스)
