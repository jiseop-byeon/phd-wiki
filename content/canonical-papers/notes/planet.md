...
- **Planning instead of a policy**: at each step, CEM (cross-entropy method) searches action
  ...
  with a learned model ([[20-robotics/index|MPC]], literally).
...
bridge between learned world models and classical [[20-robotics/index|MPC]].

### Connections

- Previous: [[world-models|World Models]] · Next: [[dreamer|Dreamer]]
- Foundations: [[vae|VAE/ELBO]], [[50-foundations/rl-basics|RL basics]], MPC ([[20-robotics/index|control track]])
...
[[20-robotics/index|MPC]] 사이의 깔끔한 개념적 다리이기도 하다.

### 연결

- 이전: [[world-models|World Models]] · 다음: [[dreamer|Dreamer]]
- 기초: [[vae|VAE/ELBO]], [[50-foundations/rl-basics|RL 기초]], MPC ([[20-robotics/index|제어 트랙]])
