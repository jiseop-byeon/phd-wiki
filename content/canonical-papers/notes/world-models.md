...
Model-free RL ([[50-foundations/rl-basics|RL basics]]) needs millions of real environment
...
- Foundations: [[vae|VAE]], [[lstm|LSTM]], [[50-foundations/rl-basics|RL basics]]
...
모델 프리 RL([[50-foundations/rl-basics|RL 기초]])은 정책망이 지각·동역학·제어를 희소한
...
- 기초: [[vae|VAE]], [[lstm|LSTM]], [[50-foundations/rl-basics|RL 기초]]
