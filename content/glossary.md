...
- **Attention** — 쿼리(Q)와 키(K)의 유사도로 값(V)을 가중합하는 연산. 시퀀스 안의 임의의 두 위치를 한 번에 연결한다. → [[01-canonical-papers/notes/attention-is-all-you-need|Transformer]]
...
- **MPC (Model Predictive Control)** — 매 시점마다 미래 구간의 최적 제어를 풀고 첫 입력만 적용하는 제어 기법. → [[04-robotics/index|제어 트랙]]
...
- **VLA (Vision-Language-Action)** — 시각·언어 입력에서 로봇 행동을 직접 출력하는 모델. → [[03-deep-learning/index|딥러닝 지도]]
