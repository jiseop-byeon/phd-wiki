...
STEPS = (
    ...
    (("identify", "panel and", "frame"), ("패널과", "프레임을", "식별"),
     ...
     ("c:5", "c:7", "d:2", "r:3.2", "r:3.5", "r:3.6", "r:3", "f:8", "f:1", "f:3",
